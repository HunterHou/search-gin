...
export const formItemTagsChange = (view:any) => {
...
export const fetchSuggestion = (queryString: string, callback:any) => {
...
export const fetchTagsLib = (queryString:any, callback:any) => {
...
export const volumechange = (e:any) => {
  const {
    target: { volume ,muted},
  } = e;
