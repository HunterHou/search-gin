...
import { ElButton, ElMessage, ElTag, ElTable, ElTableColumn, ElBadge } from 'element-plus'
...
<template>
  <div>
    <h4 align="center">
      掃描结果分析
      <el-button type="primary" :loading="indexLoading" size="small" @click="refreshIndex()"
        >重建索引
      </el-button>
    </h4>
    ...
    <li v-if="scanTime && scanTime.length > 0" class="left-div d-li">
    ...
    <li class="right-div d-li">
      <el-table :data="tableData" align="center" style="margin: 20px auto" :stripe="true" border>
        ...
        <el-table-column prop="Name" label="操作" header-align="left" align="left">
          <template #default="scope">
            <el-button v-if="!scope.row.IsDir" type="success" @click="gotoMenu(scope.row)"
              >前往
            </el-button>
            <el-button
