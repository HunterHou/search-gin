<template>
  <div ref="pagePress">
    ...
    <ElRow :gutter="24">
      <ElCol :span="!view.videoFullscreen && view.videoVisible ? 12 : 0">
        <div class="playDivMini"  v-if="!view.videoFullscreen && view.videoVisible">
          <vue3VideoPlay ref="vue3VideoPlayRef"  style="position: relative; object-fit: cover;height: auto;min-height: 500px;width: 100%;"
            v-bind="optionsPC" @timeupdate="timeupdate($event)" @volumechange="volumechange" @ended="playNext(1)" />
          <div :style="{
            color: 'white',
          ...
          ">
            ...
            <div style="margin: 8px auto; height: 34vh; overflow: auto" v-if="view.playlist && view.playlist.length > 0">
                      ...
                      <template #default>
                        <ElCard class="cmenu" :body-style="{ padding: '4px' }" @click="() => {
                          ...
                          <div>
                            ...
                            <ElRow>
                              <ElButton plain class="cmenuButton" type="success" v-for="tp in view.settingInfo.MovieTypes"
