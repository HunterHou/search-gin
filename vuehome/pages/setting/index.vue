<template>
  <div align="center">
    <el-form label-width="160px" ref="form" :model="form" label-position="right">
        ...
        <el-tabs v-model="activeName" tab-position="top" type="card" @tab-click="handleClick">
          <el-tab-pane label="扫描设置" name="first">
            <el-form-item label="图片类型">
              <el-select v-model="form.ImageTypes" multiple placeholder="请选择" style="width: 90%">
                <el-option v-for="item in form.Types" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="文档类型">
              <el-select v-model="form.DocsTypes" multiple placeholder="请选择" style="width: 90%">
                <el-option v-for="item in form.Types" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="视频类型">
              <el-select v-model="form.VideoTypes" multiple placeholder="请选择" style="width: 90%">
                <el-option v-for="item in form.Types" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="热门标签">
              ...
              ></span> -->
                ...
                <el-tag v-for="iteTag in form.Tags" :key="iteTag" closable style="margin-right: 5px"
                  @close="removeTag(iteTag)">
                  {{ iteTag }}
                </el-tag>

                <el-popover placement="left" width="400px;" trigger="click">
                  <el-transfer :titles="tagTitles" v-model="form.Tags" target-order="push"
                    :data="popTagLibData"></el-transfer>
                  <el-link slot="reference" type="success" icon="el-icon-edit" round @click="
  () => {
    makeTabLibData();
...
">添加</el-link>
            ...
            <el-form-item label="已选路徑">
              <el-checkbox :indeterminate="isIndeterminateDir" v-model="checkAll"
                @change="handleCheckAllChange">全选</el-checkbox>
              <el-checkbox-group v-model="form.Dirs" @change="handleCheckedCitiesChange">
                <el-checkbox v-for="dir in form.DirsLib" :label="dir" :key="dir">{{ dir }}</el-checkbox>
              </el-checkbox-group>
            </el-form-item>
            <el-form-item label="备注">
              <el-input type="textarea" :rows="4" v-model="form.Remark"
                style="width: 90%; margin-bottom: 20px"></el-input>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane label="基础配置" name="second">
            ...
            <el-form-item label="枚举文件类型">
              <el-select v-model="form.Types" multiple filterable allow-create default-first-option placeholder="请添加类型"
                style="width: 90%">
                <el-option v-for="item in form.Types" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
            ...
            <el-form-item label="标签库">
              <el-select v-model="form.TagsLib" multiple filterable allow-create default-first-option
                placeholder="请添加标签" style="width: 90%">
                <el-option v-for="item in form.Tags" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="路徑库">
              <el-select v-model="form.DirsLib" multiple filterable allow-create default-first-option
                placeholder="请添加路径" style="width: 90%">
                <el-option v-for="item in form.Dirs" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
            </el-form-item>
      ...
      <div>
        <el-button class="return" type="warning" align-text="center" @click="goMenu()">返回</el-button>
      </div>
      <div>
        <el-button class="submit" type="primary" align-text="center" @click="submitForm('form')">提交</el-button>
      </div>
    </el-form>
  </div>
</template>
